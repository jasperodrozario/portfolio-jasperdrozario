          ...
          <div className="flex items-center">
            ...
            >
              <Image
                ...
                width={300}
                height={300}
                className="rounded-sm object-cover transition-all duration-220 overlay-[#63FFD9] hover:-translate-[0.22em]"
              />
            </div>
          </div>
        </div>
